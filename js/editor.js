...
// 原型
    Code.prototype = {
        ...
        _createPanel: function _createPanel(value) {
            ...
            var panel = new Panel(this, {
                ...
                tabs: [{
                    ...
                    title: '插入代码',
                    // 模板
                    tpl: '<div><select id="'+ langId + '"><option>javascript</option><option>java</option><option>xml</option><option>css</option><option>html</option></select>\n           <textarea id="' + textId + '" style="height:145px;;">' + value + '</textarea>\n                        <div class="w-e-button-container">\n                            <button id="' + btnId + '" class="right">\u63D2\u5165</button>\n                        </div>\n                    <div>',
                    // 事件绑定
                    events: [
                        // 插入代码
                        {
        ...
        _insertCode: function _insertCode(value,lang) {
            var editor = this.editor;
            editor.cmd.do('insertHTML', '<pre><code class='+lang+'>' + value + '</code></pre><p><br></p>');
        },
